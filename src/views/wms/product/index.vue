              ...
              <template #default="{ row }">
                ...
                <div v-if="row.item.itemBrand">
                  {{
                    row.item.itemBrand
                      ? "品牌：" +
                        useWmsStore().itemBrandMap.get(row.item.itemBrand)
                          ?.brandName
                      : ""
                  }}
                </div>
                <div v-if="row.item.itemCategory">
                  {{
                    row.item.itemCategory
                      ? "分类：" +
                        useWmsStore().itemCategoryMap.get(row.item.itemCategory)
                          ?.categoryName
                      : ""
                  }}
                </div>
            ...
            <el-table-column label="重量(kg)" width="160" align="left">
              <template #default="{ row }">
                ...
                <div v-if="row.grossWeight" class="flex-space-between">
                  ...
                  <div>
                    {{
                      row.grossWeight || row.grossWeight === 0
                        ? row.grossWeight
                        : ""
                    }}
                  </div>
          ...
          <el-row :gutter="24">
            ...
            <el-col :span="1">
              <el-button
                ...
                icon="Plus"
                type="primary"
                style="height: 32px !important; line-height: 32px !important"
                @click="handleAddType(true)"
                >新增分类
              </el-button>
            </el-col>
          </el-row>
        ...
        >
          ...
          >
            <el-table-column label="规格名称" prop="skuName">
              <template #default="scope">
                <el-form-item
                  :prop="'itemSkuList.' + scope.$index + '.skuName'"
            ...
            >
              <template #default="scope">
                <el-button
                  ...
                  icon="Delete"
                  type="primary"
                  @click="handleDeleteItemSku(scope.row, scope.$index)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
